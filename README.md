...
<br/> 
 ...
 ##  **Вывод** 
  По таблице нагляжно видно, что подобные вычисления значительно ускоряються, при распараллеливании на потоки в CUDA - ядрах. Малый размер матриц, не так наглядно показыавет рост производительности, но на матрицах размера по-больше разница - колоссальная.
